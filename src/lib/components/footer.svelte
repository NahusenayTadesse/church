...
>
    ...
    <div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-10 pb-8 md:grid-cols-3">
            <div class="flex flex-col gap-4">
                ...
                <div class="mt-2 flex flex-col gap-3 text-sm">
                    ...
                    <a
                        href="mailto:support@stewardoflife.org"
                        target="_blank"
                        class="flex items-center gap-3 text-muted-foreground transition-colors hover:text-foreground"
                    >
                        <MailIcon class="size-4 shrink-0 text-primary" />
                        <span>support@stewardoflife.org</span>
                    </a>
                    <a
        ...
        <div class="mt-8 pt-4 flex flex-col gap-4 justify-center items-center text-center  text-muted-foreground/60">
            ...
            <p class="flex flex-row gap-3 text-[8px]">{m.footer_powered_by()}  <a href="https://nahusenaytadesse.vercel.com" class="text-primary hover:underline" target="_blank" rel="noopener noreferrer">NT
            </a></p>
        </div>
    </div>
</footer>