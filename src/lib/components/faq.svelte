...
import {
    ChurchIcon as TruckIcon,
    BookOpenIcon as PackageIcon,
    CrossIcon as ShieldCheckIcon,
    MessageCircleIcon as HelpCircleIcon,
    HeartIcon as CoinsIcon,
    FlameIcon as BatteryChargingIcon,
    UsersIcon as UsbIcon,
    BookOpenIcon as MonitorIcon
} from '@lucide/svelte';
