...
export const customerCheckoutTemplate = (orderId, items, total) => ({
	subject: `Order Confirmed - Steward of Life Electronics (#${orderId})`,
	html: `
        <div style="max-width: 600px; margin: auto; font-family: sans-serif; border: 1px solid #eee;">
            <div style="background-color: #2596be; padding: 20px; text-align: center;">
                <img src="https://Steward of Lifeelectronics.com/logo192.png" alt="Steward of Life Electronics Logo" width="80" style="display: block; margin: 0 auto 10px;">
            ...
            <div style="background: #f9f9f9; padding: 15px; text-align: center; color: #777; font-size: 12px;">
                Steward of Life Electronics | Technology you can trust.
            </div>
        </div>
    `
});
...
export const adminCheckoutTemplate = (orderId, items, total) => ({
	...
	html: `
        <div style="font-family: sans-serif; color: #333;">
            ...
            <a href="https://Steward of Lifeelectronics.com/dashboard/orders"
...
export const customerWelcomeTemplate = (name: string) => ({
	subject: `Welcome to Steward of Life Electronics, ${name}! 🎉`,
	html: `
        <div style="max-width: 600px; margin: auto; font-family: sans-serif; border: 1px solid #eee;">

            <!-- Header -->
            <div style="background-color: #2596be; padding: 20px; text-align: center;">
                <img src="https://Steward of Lifeelectronics.com/logo192.png"
                     alt="Steward of Life Electronics Logo"
                     width="80"
                     style="display: block; margin: 0 auto 10px;">
                <h1 style="color: white; margin: 0; font-size: 20px;">
                    Welcome to Steward of Life Electronics!
                </h1>
            </div>
            ...
            <div style="padding: 20px; color: #333;">
                ...
                <p>
                    We're excited to have you join <strong>Steward of Life Electronics</strong> 🔌.
                ...
                <div style="text-align: center; margin: 25px 0;">
                    <a href="https://Steward of Lifeelectronics.com"
                ...
                <p style="margin-top: 20px;">
                    Warm regards,<br/>
                    <strong>Steward of Life Electronics Team</strong>
                </p>
            </div>
	...
	html: `
        <div style="max-width: 600px; margin: auto; font-family: sans-serif; border: 1px solid #eee;">
            ...
            <div style="padding: 20px; color: #333;">
                ...
                <p style="margin-top: 20px;">
                    Thank you for choosing <strong>Steward of Life Electronics</strong>. We look forward to serving you again!
                </p>
            </div>
	...
	html: `
        <div style="font-family: sans-serif; color: #333; max-width: 600px; margin: auto; border: 1px solid #eee;">
            ...
            <div style="background: #f9f9f9; padding: 10px; text-align: center; font-size: 12px; color: #777;">
                Steward of Life Electronics - Contact Form Notification
            </div>
        </div>
    `
});
...
export const customerContactTemplate = (name: string, subject: string) => ({
	subject: `We received your message - Steward of Life Electronics`,
	html: `
        <div style="max-width: 600px; margin: auto; font-family: sans-serif; border: 1px solid #eee;">
            ...
            <div style="padding: 20px; color: #333;">
                ...
                <p>
                    Thank you for reaching out to <strong>Steward of Life Electronics</strong>.
                ...
                <p style="margin-top: 20px;">
                    If your request is urgent, feel free to contact us directly at <strong>+251 933 111 111</strong> or <strong>info@Steward of Lifeelectronics.com</strong>.
                </p>
...
export const customerResetPasswordTemplate = (url: string) => ({
	subject: `Reset Your Password - Steward of Life Electronics`,
	html: `
        <div style="max-width: 600px; margin: auto; font-family: sans-serif; border: 1px solid #eee;">
            <!-- Header -->
            <div style="background-color: #2596be; padding: 20px; text-align: center;">
            ...
            <div style="padding: 20px; color: #333;">
                ...
                <p>
                    ...
                    <strong>Steward of Life Electronics</strong> account.
                </p>
