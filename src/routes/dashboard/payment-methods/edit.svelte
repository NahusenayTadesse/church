...
<DialogComp title={icon ? 'Edit' : name} variant="ghost" IconComp={icon ? SquarePen : undefined}>
	<form {action} use:enhance method="post" id="edit" class="flex w-full flex-col gap-4 p-4" enctype="multipart/form-data">
		...
		/>
				<InputComp {form} {errors} label="Logo" type="file" name="logo" image={logo} />
