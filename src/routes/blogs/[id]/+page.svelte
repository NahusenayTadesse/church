<script lang="ts">
	...
	const pageTitle = $derived(`${post?.title ?? 'Steward of Life Technology Guide'} | Steward of Life Blog`);
	const pageDescription = $derived(
		post?.excerpt ||
			'Read Steward of Life guides about electronics, mobile accessories, power solutions, storage devices, audio products, smart technology, warranty support, and everyday digital convenience.'
	);
</script>
...
<svelte:head>
	...
	<meta
		name="keywords"
		content="Steward of Life blog, Steward of Life Electronics, electronics Ethiopia, Addis Ababa electronics, mobile accessories, power solutions, storage devices, audio products, smart electronics"
	/>

	<meta property="og:type" content="article" />
	<meta property="og:url" content={`https://Steward of Lifeelectronics.com/blogs/${post?.slug ?? ''}`} />
	<meta property="og:title" content={pageTitle} />
	<meta property="og:description" content={pageDescription} />
	<meta
		property="og:image"
		content={`https://Steward of Life.et/files/${post?.featuredImage ?? 'logo.png'}`}
	/>
	<meta property="article:section" content={post?.category || 'Electronics Guide'} />
	<meta property="article:author" content="Steward of Life Electronics" />

	<meta name="twitter:card" content="summary_large_image" />
	<meta name="twitter:url" content={`https://Steward of Life.et/blogs/${post?.slug ?? ''}`} />
	...
	<link rel="canonical" href={`https://Steward of Life.et/blogs/${post?.slug ?? ''}`} />
	<meta name="author" content="Steward of Life Electronics" />
</svelte:head>
...
>
	...
	<section class="relative -mt-14 px-4 pb-20 sm:px-6 lg:px-8">
		...
		>
			...
			>
				<h2 class="text-2xl font-black tracking-tight">Need help choosing a Steward of Life product?</h2>
				<p class="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground">
					Explore our products or contact Steward of Life support for help choosing the right electronics,
