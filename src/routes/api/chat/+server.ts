		...
		functionDeclarations: [
			{
				...
				description:
					'Search the public Steward of Life Electronics product catalog. Use only for Steward of Life product-related questions such as product availability, prices, categories, tags, and recommendations.',
				parameters: {
					type: Type.OBJECT,
					properties: {
						query: {
		...
		for (const call of functionCalls) {
			...
			try {
				...
				functionResponses.push({
					...
					response: {
						error:
							'Product search failed. Tell the user to visit the Shop page or contact Steward of Life support.'
					}
				});
			}
		}
